...
def binary_classification_adaboost(
    ...
    **kwargs,
    ...
    Args:
        ...
        set_learning_rate:
            set AdaBoost hyper-parameter [learning_rate] to a single
            value.
        set_n_estimators:
            set AdaBoost hyper-parameter [n_estimators] to a single
            value.
        **kwargs:
            class_labels:
    ...
    print("\nAdaBoost hyper-parameters tuning end.")
    ...
    **kwargs,
    ...
    Args:
        ...
        max_depth_max:
            ...
            that hyper-parameters tuning will iterate through.
        set_max_depth:
            set BalancedRandomForestClassifier hyper-parameter
    ...
    print("\nBalancedRandomForest hyper-parameters tuning end.")
...
#     CAT_Parameters = []
#
#     # Setting the lists of hyper-parameters for CatBoost
...
def binary_classification_extra_trees(
    ...
    **kwargs,
    ...
    print("\nExtraTrees hyper-parameters tuning end.")
...
def binary_classification_random_forest(
    ...
    **kwargs,
    ...
    Args:
        ...
        set_max_depth:
            set RandomForestClassifier hyper-parameter [max_depth] to a
            single value.
        set_n_estimators:
            set RandomForestClassifier hyper-parameter [n_estimators] to
            a single value.
        set_max_features:
            set RandomForestClassifier hyper-parameter [max_features] to
            a single value.
        set_max_samples:
            set RandomForestClassifier hyper-parameter [max_samples] to
            a single value.
        **kwargs:
            class_labels:
                keyword arguments for model_performance_analysis()
    ...
    print("\nRandomForest hyper-parameters tuning end.")
    ...
    **kwargs,
    ...
    Args:
        ...
        set_colsample_bytree:
            set XGBoost hyper-parameter [colsample_bytree] to a single
            value.
        set_max_depth:
            set XGBoost hyper-parameter [max_depth] to a single value.
        set_sample_weights: 1d array-like,
            weights of each sample if specified.
        set_scale_pos_weight:
            set XGBoost hyper-parameter [scale_pos_weight] to a single
            value.
        set_subsample:
            set XGBoost hyper-parameter [subsample] to a single value.
        use_default_api:
    ...
    print("XGBoost hyper-parameters tuning end.")
