...
def _load_best_hyperparameter(
    ...
    """Load best hyper-parameter set based on model cross-validation
    results.
    ...
    Args:
        ...
        hyper_parameter_sets: 1d array,
            list of hyper-parameters in the same order of cv_results
        check_overfitting:
        ...
        model_type:
            ...
            CROSS_VALIDATORS
        verbose:
            if True, print out the best hyper-parameters
    Return:
...
def _load_hyperparameter_sets(
    ...
    """Load a list of combinations of provided hyper-parameters

    Args:
        parameters_to_grid:
            dictionary with key as hyper-parameter and value as a
            list of hyper-parameter values, a dictionary containing
            hyper-parameters that will be tuned over cross-validation
        base_parameters:
            dictionary with key as hyper-parameter and value as
            hyper-parameter value, a dictionary containing the
            hyper-parameters that will be constant over cross-
            validation
    Return:
...
def _model_hyper_parameter_tuning(
    *args, params_sets: List = None, model_type: str = "", **kwargs
    ...
    Args:
        *args:
        ...
        params_sets: list of dictionaries,
            dictionaries with key as model hyper-parameter and value
            as hyper-parameter value
        model_type:
            type of model. Supported values are the keys in variable
            CROSS_VALIDATORS
        **kwargs:
    ...
    print(f"Start tuning hyper-parameters: ({len(params_sets)} sets)")
